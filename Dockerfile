...
RUN echo "alias moveit_config_driver=\"/home/${USERNAME}/workspace/driver_sripts/driver-moveit-start.sh\"" >> /home/${USERNAME}/.bashrc
RUN echo "alias ur_driver=\"/home/${USERNAME}/workspace/driver_sripts/driver-ur-start.sh\"" >> /home/${USERNAME}/.bashrc
RUN echo "alias realsense_driver=\"/home/${USERNAME}/workspace/driver_sripts/driver-realsense-start.sh\"" >> /home/${USERNAME}/.bashrc
