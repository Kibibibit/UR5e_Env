...
bool par_interfaces__msg__gripper_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("par_interfaces.msg._gripper_info.GripperInfo", full_classname_dest, 44) == 0);
  }
  par_interfaces__msg__GripperInfo * ros_message = _ros_message;
  {  // gripper_type
...
PyObject * par_interfaces__msg__gripper_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("par_interfaces.msg._gripper_info");
