...
static const _GripperInfo_type_support_symbol_names_t _GripperInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, par_interfaces, msg, GripperInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, par_interfaces, msg, GripperInfo)),
  }
};
...
{
  return &::par_interfaces::msg::rosidl_typesupport_cpp::GripperInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, par_interfaces, msg, GripperInfo)() {
  return get_message_type_support_handle<par_interfaces::msg::GripperInfo>();
}
